...
.login .wrapper{
  ...
  .language-sel-en{background: url(../../bitStyle/images/gb.png) no-repeat 0 0 !important}

  .language-sel-zh-CN{background: url(../../bitStyle/images/cn.png) no-repeat 0 0 !important}
  ...
  <div class="container">
    ...
    <ul class="nav navbar-nav navbar-right" role="sub-navigation">
        ...
        <a href="#" data-toggle="dropdown">
          ...
          <span class="language-sel-en fa-lang"></span>
        ...
        <ul class="dropdown-menu" role="languageMenu">
                                        ...
                                        <li><a href="<?php echo U('Login/english');?>"><span class="language-sel-en"></span>English</a></li>

                                                              <li><a href="<?php echo U('Login/index');?>"><span class="language-sel-zh-CN"></span>简体中文</a></li>
...
<div class="wrapper">
  ...
  <div class="widget">
    ...
    <div class="widget-body">
      ...
      <div class="brand">
                ...
                <a href="" class="appbrand"><img src="/bitStyle/images/nmm_logo_login.png" alt="  "></a>
      ...
      <h1>Login</h1>
        ...
        <input type="text" class="form-control" name="account" autofocus id="username" value="" placeholder="Username">
        ...
        <div class="row" style="text-align:center;">
          ...
          <div class="col-md-12">
            ...
            <input class="btn btn-block btn-primary" type="button" name="submit" value="Login" id="login_btn" />

            <a class="btn btn-block btn-success" type="button" name="submit"  id="login_btn" href="<?php echo U('Reg/index');?>" />Register</a>

            <!-- <a href="/bitStyle/zh-CN/forgot-password?source=login" class="forgot-password">找回密码</a> -->
  ...
  &copy; 2016 . All rights reserved. </div>
