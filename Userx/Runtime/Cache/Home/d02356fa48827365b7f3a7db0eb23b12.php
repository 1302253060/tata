			...
			setInterval(function(){
				$.ajax({
					...
					success: function(data){
						if(data.loggedout == '1'){
							window.location.href = "http://www.bitww68.com/zh-CN/";
						}
					}
				})
			}, 300000); //5min
						...
						<div class="col-md-12 tablet-column-reset">
							<div class="widget">
								...
								<div class="widget-body margin-none">
										...
										<h5><?php echo ($data["if_theme"]); ?><h5>
										<p class="text-muted"><?php echo ($data["if_time"]); ?></p>
										<p class="margin-none"><?php echo ($data["if_content"]); ?></p>
									</div>
																										</div>
								<footer class="data-footer innerAll half text-right clearfix">
									<div class="pull-left">
										<a href="#" onClick="javascript:history.back();" class="btn btn-inverse btn-sm">返回</a>
									</div>
