                    ...
                    <div class="col-md-9">
                        ...
                        <div class="widget">
                            <div class="widget-head" style="background:#555; ">
                                <h4 class="heading" style="color:#fff">新信息</h4>
                            </div>
                            <form class="form-horizontal margin-none" method="post" action="<?php echo U('Home/Myuser/lxwmcl');?>">
                                <div class="widget-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                             <input type="text" required="" name="lybt" id="lybt" class="form-control" placeholder="主题">
                                                                                    </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label"><strong>信息</strong></label>
                                        <div class="col-md-9">
                                            <textarea required="" name="lynr" id="lynr" class="form-control form-control-text-area" rows="5" placeholder="信息"></textarea>
                                        
                                                                                    </div>
                                    </div>
                                </div>
                                <footer class="data-footer innerAll half text-right clearfix">
                                    <a href="<?php echo U('Myuser/lxwm');?>" class="btn btn-default btn-sm">取消</a>&nbsp;&nbsp;
                                    <input name="" class="btn btn-primary pull-right btn-sm" type="submit" id="btn" value="发送信息">
                                </footer>
                            </form>
                        </div>
                    </div>
