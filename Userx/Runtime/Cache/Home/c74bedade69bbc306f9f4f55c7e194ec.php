...
<!-- Main Wrapper -->
  ...
  <div class="color-line"></div>
            ...
            </div> <form class="" method="post" id="pfrom" enctype="multipart/form-data" action="/Home/Index/home_ddxx_pcz_cl/">
            <div class="modal-body" >

                <input type="radio" class="comfir2" value="1" name="comfir2">我已完成打款<br>
            ...
            <div style="font-size:9pt;">
                <a class="btn btn-primary btn-sm" id="btn">上传图片</a>　　　　<input type="submit" id="btn_approve_donation" class="btn btn-primary btn-sm" value="确认已付款"><br>
<br>
        ...
        <script type="text/javascript" src="/js/xz/sucaihuo.js"></script>
                ...
                <div >
                    　　　<!--　<button type="submit" class="btn-primary" id="select_fanshi3">确认</button>--><br>
<br>
