...
<div class="wrapper">
  ...
  <div class="widget">
    ...
    <div class="widget-body">
      <div class="brand">
                <a href="https://shop144157467.taobao.com" class="appbrand"><img src="/bitStyle/images/nmm_logo_login.png" alt="  "></a>
      </div>
      <h1 style="color:#f3cb5d">TATA环球金融社区</h1>
        ...
        <input type="text" class="form-control" name="account" autofocus id="username" value="" placeholder="手机号">
        ...
        <div class="row" style="text-align:center;">
          ...
          <div class="col-md-12">
            <input class="btn btn-block btn-primary" type="button" name="submit" value="Sign in" id="login_btn" />
            <a class="btn btn-block btn-success" type="button" name="submit"  id="login_btn" href="/Home/Reg/index.html" />Register</a>
            <a class="btn btn-block" type="button" name="submit"  id="login_btn" href="/Home/Reg/forgot.html" />Forget Password</a>
  ...
  <div class="copyright">
  &copy;  2016 TATA环球金融社区. All rights reserved. </div>
</div>
