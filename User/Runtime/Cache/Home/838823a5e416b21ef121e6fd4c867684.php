...
<div id="wrapper">
  ...
  <div class="container" >
    ...
    <div class="col-md-9">
        ...
        <div class="col-md-3">
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="widget donate-sidebar gdContainer-pending ">
              <div class="widget-body">
