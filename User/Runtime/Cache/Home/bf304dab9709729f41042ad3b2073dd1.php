...
<style>
.form-group{ width:30%; float:left;}
							...
							<fieldset >
								...
								<div class="widget-body" >
									...
									<div class="form-group">
										<label class="col-md-2 control-label" for="firstname" style="float:left;" >
											转帐数额:
										</label>
										<div class="col-md-8" style="float:left;">
										<div class="input-group">		
											<input name="sh" type="text" id="sh" placeholder="您的PIN余额为<?php if($pin_zs): echo ($pin_zs); else: ?>0<?php endif; ?>" class="targetinput form-control form-control-group" style="float:left;" >
													<span class="input-group-btn">										
								
							
									<input type="submit" name="Submit" value="确认转让" class="btn btn-success btn-sm" style="background:#47a447; color:#fff" style="float:right;">			
								</div>
                        ...
                        <div class="widget-body innerAll overthrow">
                            ...
                            <tbody>
                                    <?php if(is_array($list1)): foreach($list1 as $key=>$v): ?><tr role="row" class="odd">
                                      <td class="sorting_1"><?php echo (md5($v["id"])); ?></td>
