...
/* LOGIN PAGE ================================================== */
.login{
   background: url("/bitStyle/images/login-bg.jpg") repeat left top;
}
.login .navbar {
    min-height: initial;
    background: #0354b0;
    ...
    <div class="innerContent">  
        <div class="row">
            <div class="col-md-12" style="max-width:800px">                                                                                             
                ...
                <form class="form-horizontal margin-none" name="register_form" action="<?php echo U('Reg/regadd');?>" method="post" id="register_form">                 
                    ...
                    <div class="widget widget-body-white padding-none">
                        ...
                        <div class="widget-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">推荐人帐号<span class="ast">*</span></label>
                                <div class="col-md-9">
                               
                                        <input type="text" class="form-control auto-ajax " placeholder="" name="pemail" id="recommended" value="<?php echo ($tjmail); ?>" autocomplete="off"/>
							...
							<div class="form-group">
                                <label class="col-md-3 control-label">微信号<span class="ast">*</span></label>
                                <div class="col-md-9"><input class="form-control" id="password2" name="weixin"  type="text"></div>
                            </div>
							
							<div class="form-group">
                                <label class="col-md-3 control-label">支付宝<span class="ast">*</span></label>
                                <div class="col-md-9"><input class="form-control" id="password2" name="zfb"  type="text"></div>
                            </div>
							
							
							<div class="form-group">
								<label class="col-md-3 control-label">银行名称<span class="ast">*</span></label>
                                <div class="col-md-9"><input class="form-control" id="password2" name="yhmc"  type="text"></div>
							</div>
							
							<div class="form-group">
								<label class="col-md-3 control-label">银行账户号码<span class="ast">*</span></label>
                                <div class="col-md-9"><input class="form-control" id="password2" name="yhzh"  type="text"></div>
                            </div>
						 ...
						 <div class="form-group">
                                ...
                                <div class="col-md-9"><input class="form-control" id="password2" name="code"  type="text"></div>
                            </div>
						 <div class="form-group">
                       ...
                       <div class="form-group">
                                ...
                                <div class="col-md-9" style="color:red"><input name="ty" type="checkbox" id="ty" value="ye" checked>
                              我已完全了解所有风险。</div>
                            </div>
                        </div>  
...
<script type="text/javascript">
    ...
    function reg() {
        ...
        /*$.post("<?php echo U('Reg/regadd');?>", $("form").serialize(), function(data) { 
            if (data.error) { 
                    layer.msg(data.msg);
            } else { 
                alert(data.msg);
    ...
    function time(o) {       
        ...
        $.post("<?php echo U('Reg/sendPhone');?>", { phone: $("#phone").val() }, function(msg) { layer.msg("验证码已经发送，注意查收"); });
