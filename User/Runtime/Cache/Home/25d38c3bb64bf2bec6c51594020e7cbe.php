							...
							<table class="table table-bordered table-primary">
								<thead>
									<tr class="tac">
										...
										<th style="background:#555; color:#fff">详情 </th>
										<th style="background:#555; color:#fff">匹配金额</th>
										<th style="background:#555; color:#fff">奖金</th>
										<th style="background:#555; color:#fff">匹配编号</th>
										<th style="background:#555; color:#fff">发放状态</th>
										<th style="background:#555; color:#fff">交易状态</th>
										<th style="background:#555; color:#fff">日期</th>
									</tr>
								</thead>
							<tbody>
                                <?php if(is_array($list2)): foreach($list2 as $key=>$d): ?><tr role="row" class="odd">
                                        <td class="sorting_1"><?php ?> <?php echo (md5($d["id"])); ?></td>                                                
                                        <td><?php echo ($d["note"]); ?></td>
                                        <td><?php echo ($d["jb"]); ?></td>
                                        <td><?php echo ($d["jj"]); ?></td>
                                        <td>C<?php echo ($bbh=$d["r_id"]); ?></td>
