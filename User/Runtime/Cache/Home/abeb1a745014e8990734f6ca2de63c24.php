							...
							<table class="table table-bordered table-primary">
								<thead>
									<tr class="tac">
										...
										<th style="background:#555; color:#fff">日期</th>
										<th style="background:#555; color:#fff">说明</th>
										<th style="background:#555; color:#fff">金额 </th>
										<th style="background:#555; color:#fff">利息 </th>
										<th style="background:#555; color:#fff">天数</th>
										<th style="background:#555; color:#fff">提现 </th>
										<th style="background:#555; color:#fff">是否转出</th>
										<th style="background:#555; color:#fff">匹配编号  </th>
										<th style="background:#555; color:#fff">匹配状态</th>
									</tr>
								</thead>
							 <tbody>
                                        ...
                                        <?php if(is_array($list1)): foreach($list1 as $key=>$v): ?><tr role="row" class="odd">
                                                <td class="sorting_1"><?php echo (md5($aab=$v["id"])); ?></td>
                                                <td><?php echo ($v["date"]); ?></td>
                                                <td>提供帮助</td>
                                                <td><?php echo ($v["jb"]); ?></td>
