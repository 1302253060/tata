...
<!-- Main Wrapper -->
  ...
  <div class="color-line"></div>
            <div class="modal-header">
                <h5 class="modal-title" id="title24">对方-超过24小时未确认收款</h5>
                <small class="font-bold"></small>
            </div> <form class="" method="post" id="pfrom" enctype="multipart/form-data" action="/Home/Index/home_ddxx_g_wqr_cl/">
			<div class="modal-body" style="height:300px;">
                汇款成功后,如果对方24小时未确认收款,可在此投诉!<br>
                如果您被对方投诉,请与对方取得联系!
				<br>
