...
<!-- Main Wrapper -->
 ...
 <p><strong>Order: R<span id="orderid"><?php echo ($ppddxx["id"]); ?></span></strong></p>
<?php if(is_array($list)): foreach($list as $key=>$v): ?>用户:<?php echo ($v["user_nc"]); ?> 时间:<?php echo ($v["date"]); ?><br>
内容:<?php echo ($v["nr"]); ?> <hr><?php endforeach; endif; ?>
