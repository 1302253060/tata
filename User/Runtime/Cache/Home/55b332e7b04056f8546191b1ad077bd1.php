...
<body class="zh-CN " id="">
        ...
        <a href="/Home/Index/index.html" class="navbar-brand" >
          <img src="/bitStyle/images/logo_white.png" alt="">
		   ...
		   <div class="pull-left" id="userRank" style="margin-top:15px">
                       ...
                       欢迎您： <?php echo ($userData['levelname']); ?> <span style=" color:red"><?php echo ($userData['ue_account']); ?></span> ，   <a href="/Home/Reg/logout.html">退出</a>                   </div>
      </div>
  ...
  <li ><a href="/Home/Info/rwhistory.html">静态收益记录</a></li>
              ...
              <li ><a href="/Home/Info/pin.html">激活码管理</a></li>
			    <li ><a href="/Home/Info/pintopin.html">激活码转让</a></li>
...
<div id="wrapper" >
			...
			<div class="row" style="padding-top:60px; margin:0px auto;">
				<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<input name="sh" type="text" id="sh" class="form-control ">
																						<p class="help-block">您的PIN余额为：<strong class="green"><?php if($pin_zs): echo ($pin_zs); else: ?>0<?php endif; ?></strong></p>
																																</div>
									</div>
