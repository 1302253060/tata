...
.white_content{ width:500px;position:absolute;
top:60px; left:50%; margin-left:-250px;
display: none;
z-index:1002;
overflow: auto;}
@media screen and (max-width: 640px) {

.white_content{width: 100%;position:absolute;
top:60px;  margin-left:0px; left:0px;
...
document.getElementById(bg_div1).style.display='none';
              ...
              <title>1-11</title><div id="fade" class="black_overlay">
</div>
           <div id="fade1" class="black_overlay">
</div>
                  <div class="container" style="padding-top:60px;">
				    <div class="pull-left" id="userRank" style="color:#fff">
                        <span class="glyphicon glyphicon-user"  >
                        </span>
                       欢迎您： <?php echo ($userData['levelname']); ?> <span style=" color:red"><?php echo ($userData['ue_account']); ?></span> ，   <a href="/Home/Reg/logout.html" style="font-size:16px;color:#FAC847; font-weight:bold;">退出</a>                   </div> </div>
                              ...
                              class="form-horizontal margin-none" id="provide_help">
                                ...
                                <div class="widget-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                      <input type="text" class="form-control get_amount" placeholder="请输入帮助金额"
								  ...
								  <div class="form-group">
                                      ...
                                      <div class="col-md-9">
                                        <input  type="password" class="form-control get_amount"   placeholder="请输入二级密码"  name="pass2" autocomplete="off" required>
                                ...
                                <fieldset>
                                  ...
                                  <div class="widget-body">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9">
                                        <input type="text" class="form-control get_amount" placeholder="请输入接受帮助金额"
      ...
      <input type=radio name=favorite value="直推收益">直推收益
            ...
            <div class="widget-body innerAll">
              <table width="100%">
                  ...
                  <?php if(is_array($plist)): $i = 0; $__LIST__ = $plist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$o): $mod = ($i % 2 );++$i;?><tr  class="odd" role="row" style="float:left;padding:10px;background: -ms-linear-gradient(top, #f8f0d9,  #fac335);        /* IE 10 */
...
background: -o-linear-gradient(top, #f8f0d9, #fac335);  /*Opera 11.10+*/
    ...
    border-radius:10px;            /* W3C syntax */ float:left; width:100%; margin-bottom:10px;" >
										  ...
										  <td>
                                              <?php if($o["zt"] == 0): ?><td style=" text-align:right; width:20%; font-weight:bold;font-size:16px;">
											剩余付款时间 <br/> <span style="color:#008001"><?php echo ($o["pay_limit_time"]); ?></span><?php endif; ?>
											</td>
											<?php if($o["zt"] == 1): ?><td style=" text-align:right; width:20%; font-weight:bold;font-size:16px; ">
											剩余确认时间<br/> <span style="color:#008001"><?php echo ($o["pay_limit_time"]); ?> </span>
											</td><?php endif; ?>
