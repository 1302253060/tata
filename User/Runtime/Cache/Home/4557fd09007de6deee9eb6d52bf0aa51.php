...
<!--[if lt IE 7]>
  ...
  <li ><a href="/Home/Info/pdhistory.html">静态收益</a></li>
                      ...
                      <div id="donationWrap">
                        ...
                        <div class="row">
                              ...
                              class="form-horizontal margin-none" id="provide_help">
                                ...
                                <div class="widget-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                      <input type="text" class="form-control get_amount" placeholder="输入<?php echo ($tj_start); ?>-<?php echo ($tj_e); ?>,且为<?php echo ($tj_beishu); ?>的整数倍"
                          ...
                          <div class="col-md-12" id="gdWrap" style="">
                            <div class="widget widget-body-white">
                              <form action="/Home/Index/jsbzcl2" method="post" name="wallet_transfer_form"
                                ...
                                <fieldset>
                                  ...
                                  <div class="widget-body">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9">
                                        <input type="text" class="form-control get_amount" placeholder="输入RMB,<?php echo ($tj_start); ?>到<?php echo ($tj_e); ?>,<?php echo ($tj_beishu); ?>的倍数"
                                        name="get_amount" autocomplete="off" required>
                                        <p class="help-block">
                                          您现有可出售推荐奖余额： <?php echo ($userData['tj_he']); ?>RMB
                                        </p>
                                        <p class="help-block">
                                          您最低出售数量 <?php if($tj_start > $userData['ue_money']): echo ($userData['tj_he']); else: echo ($tj_start); endif; ?>RMB
                                        </p>
                                        <p class="help-block">
                                          警告，我已完全了解所有风险。我决定参与云致富万众普惠社区,尊重云致富万众普惠社区文化与传统。
                                        </p>
