...
<!-- Favicons -->
<link rel="shortcut icon" href="http://www.bitww68.com/images/favicons/favicon.ico" type="image/x-icon">
                        ...
                        <div class="col-md-12 tablet-column-reset">
                            <div class="widget">
                                <div class="widget-head" style="background:#555">
                                    <h4 class="heading" style="color:#fff">公告</h4>
                                </div>
                                <div class="widget-body margin-none">
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><div class='media-body innerAnnounce'>
                                              <div class='readMore' data-url="<?php echo U('Index/newsPage',array(id=>$info['if_id']));?>">
                                                <h5>
                                                  <a href="<?php echo U('Index/newsPage',array(id=>$info['if_id']));?>">
                                                    <?php echo ($info["if_theme"]); ?>
                                                  </a>
                                                </h5>
                                                <p class='text-muted'>
                                                  <?php echo ($info["if_time"]); ?>
                                                </p>
                                ...
                                <footer class="data-footer innerAll half text-right clearfix">
                                    <div class="pull-left">
                                        <a href="<?php echo U('Index/home');?>" class="btn btn-inverse btn-sm">返回</a>
                                    </div>
