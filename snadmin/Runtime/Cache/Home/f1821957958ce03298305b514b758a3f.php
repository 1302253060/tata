...
<body>
    ...
    <div class="rightinfo">
      <form action="/admin.php/Home/Index/jsbz_list_sd_cl"  name="xgmm" id="xgmm" method="post">

   <?php iniInfo(); ?>
    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><?php echo ($aab[c]=1); ?> 提现用户:<?php echo ($aab[a]=$tgbzuser["user"]); ?>  提现金额:<?php echo ($tgbzuser["jb"]); ?> </td>
