  ...
  <tr>
    ...
    <table class="tablelist">
		...
		<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
		 <td><?php echo ($v["id"]); ?> <a onClick="javascript:if(!confirm('确认要删除吗？'))  return  false; " href="/admin.php/Home/Index/tgbz_list_del/id/<?php echo ($v["id"]); ?>" >删除</a></td>
		 <td style="color:<?php echo ($v["type"]); ?>"><?php echo ($v["user"]); ?></td>
		  <td>
        ...
        <td><a href="/admin.php/Home/Index/tgbz_list_sd/id/<?php echo ($v["id"]); ?>/">手动匹配</a></td>
