    ...
    <table class="tablelist">
		...
		<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
		 ...
		 G<?php echo ($v["g_id"]); ?>		  </td>
		   <td style="color:<?php echo ($v["style"]); ?>"><?php echo ($v["p_user"]); ?>asas</td>
        ...
        <td><a href="/admin.php/Home/Index/ts1_list_cl/id/<?php echo ($v["id"]); ?>/">重新匹配</a></td>
...
.pages span.current{
   ...
   <div class="pages"><br />
     ...
     <div align="right"><?php echo ($page); ?><hr>
						<?php echo ($jjdktime); ?>小时未打款处理方案建议,点重新匹配,可手动封了未打款的账号!
                        </div>
   </div>
