...
<body>
    ...
    <ul class="forminfo">
	<li><label>会员編号</label><input name="UE_account1" type="text" class="dfinput" value="<?php echo ($userdata['ue_account']); ?>" /><i>可修改</i></li>
	<li><label>推荐人</label><input name="UE_accName" type="text" class="dfinput" value="<?php echo ($userdata['ue_accname']); ?>"/><i>可修改</i></li>
	<li><label>报单中心</label><input name="UE_theme" type="text" class="dfinput" value="<?php echo ($userdata['ue_theme']); ?>"/><i>可修改</i></li>
	...
	<li><label>经理钱包</label><input name="jl_he" type="text" class="dfinput" value="<?php echo ($userdata['jl_he']); ?>"/></li>
	<li><label>直推收益</label><input name="tj_he" type="text" class="dfinput" value="<?php echo ($userdata['tj_he']); ?>"/></li>
