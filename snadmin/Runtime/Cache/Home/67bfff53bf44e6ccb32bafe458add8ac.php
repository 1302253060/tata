...
<div class="formbody">
    ...
    <div class="core_con">
	<div style="font-size:9pt;"><form action="" method="get"><input name="user1" id="user1"  type="hidden" value="<?php echo ($user); ?>" />會員賬號 : <input id="user" name="user" type="text"> <input name="" type="button" id="btn" value="搜索">
