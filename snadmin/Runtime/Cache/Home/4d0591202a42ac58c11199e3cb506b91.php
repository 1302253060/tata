...
<body>
  ...
  <tr>
    <td> <form id="form1" name="form1" method="post" action="/admin.php/Home/Index/ppdd_list">
	 
   <input name="user" type="text" class="dfinput" id="user" />
	<input name="" type="submit" class="btn" value="确认搜索"/>
      </form></td>
    <td align="right"><a href="/admin.php/Home/Index/ppdd_list/cz/0/">交易中</a> <a href="/admin.php/Home/Index/ppdd_list/cz/1/">交易成功</a></td>
  </tr>
  <tr>
    ...
    <table class="tablelist">
        ...
        <td style="color:<?php echo ($v["style"]); ?>"><?php echo ($v["jb"]); ?>		</td>
        ...
        <td><!--<a href="/admin.php/Home/Index/ts2_list_cl/id/<?php echo ($v["id"]); ?>/">确认汇款处理</a>-->
          <?php if($v["pic2"] == ''): ?>会员未上传<?php else: ?><a href="<?php echo ($v["pic2"]); ?>" target="_blank">点击查看</a><?php endif; ?></td>
        <td><a href="/admin.php/Home/Index/ts3_list_cl/id/<?php echo ($v["id"]); ?>/">重新匹配</a></td>
