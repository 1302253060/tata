...
<label></label>
<div class="rightinfo">
  <form action="/admin.php/Home/Shop/jbzg_list_xgcl2"  enctype="multipart/form-data" name="xgmm" id="xgmm" method="post">
...
<table width="90%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" class="tablebg" id="table1">
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF" class="tbval"><div class='edit-face'>
	    				<img src="<?php echo ($caution["if_webimg"]); ?>" width='140' height='140' id='face-img'/>
	    				<p>
	    					<input type="file" name='face' id='face'/>
	    				</p>
   				  <p>
                            <input type="hidden" name='face180' value='<?php echo ($caution["if_webimg"]); ?>'/>
			</p>
		</div></td>
  </tr>
  <tr>
